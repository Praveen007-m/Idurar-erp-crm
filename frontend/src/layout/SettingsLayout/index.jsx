...
const TopCard = ({ title, cardContent }) => (
  <div
    ...
    style={{ color: '#595959', fontSize: 13, height: '70px', minHeight: 'auto', marginBottom: '24px' }}
  >
...
export default function SettingsLayout({ children, topCardTitle, topCardContent, bottomCardContent }) {
  return (
    <Layout className="site-layout">
      <Content style={{ padding: '30px 40px', margin: '0px auto', width: '100%', maxWidth: '1100px' }}>
        <Row gutter={[24, 24]}>
          <Col className="gutter-row" xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 17 }} lg={{ span: 18 }}>
          ...
          <Col className="gutter-row" xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 7 }} lg={{ span: 6 }}>
